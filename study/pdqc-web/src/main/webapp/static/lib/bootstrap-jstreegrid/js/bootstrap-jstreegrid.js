		...
		this._initialize = function () {
			if (!this._initialized) {
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top; border-radius:0px;overflow:hidden;margin-left:0;position:relative;width: 100%;padding-left:0px;white-space: nowrap;}',
	          ...
	          '.jstree-grid-header-cell {overflow: hidden; white-space: nowrap;padding: 1px 0px 2px 5px;}',
						'.jstree-grid-header-themeroller {border: 0; padding: 1px 3px;}',
						'.jstree-grid-header-regular {background-color: #f5f5f5;border-bottom: 1px solid #ddd;}',
