    ...
    return this.each(function () {
      ...
      strategies['default'] = function (iframe, $iframeBody, options, browser) {
        // NOTE: this is how the plugin determines the iframe height, override if you need custom
    	  ...
    	  if(iframeWin && iframeWin.contentDocument.documentElement.scrollHeight){
    		  height = iframeWin.contentDocument.documentElement.scrollHeight;
    	  }else if(iframeWin && iframeWin.contentDocument.body.scrollHeight){
    		  height = iframeWin.contentDocument.body.scrollHeight;
    	  }
        return height  + options.heightOffset;
      };
      ...
      function resizeHeight(iframe) {
    	options.callbefore.apply($(iframe), [{newFrameHeight: newHeight}]);
