...
/**
 * Table [pd_d_patient_inspection_electrocardiogram]`s Columns.
 */
public enum PdDPatientInspectionElectrocardiogramColumnEnum implements ModelColumn {
    ...
    DIAGNOSIS("diagnosis", "VARCHAR", "diagnosis", java.lang.String.class, false, true, false),
    ...
    PdDPatientInspectionElectrocardiogramColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
