...
/**
 * Table [pd_m_role_func]`s Columns.
 */
public enum PdMRoleFuncColumnEnum implements ModelColumn {
    ...
    PdMRoleFuncColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
