...
/**
 * Table [pd_d_patient_outcome]`s Columns.
 */
public enum PdDPatientOutcomeColumnEnum implements ModelColumn {
    ...
    ROWVERSION("row_version", "INTEGER", "rowVersion", java.lang.Integer.class, false, true, false),
    ...
    PdDPatientOutcomeColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
