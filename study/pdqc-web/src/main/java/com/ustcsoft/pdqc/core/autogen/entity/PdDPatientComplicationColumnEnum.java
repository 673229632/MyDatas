...
/**
 * Table [pd_d_patient_complication]`s Columns.
 */
public enum PdDPatientComplicationColumnEnum implements ModelColumn {
    ...
    REASON("reason", "VARCHAR", "reason", java.lang.String.class, false, true, false),
    ISHPSIPTALIZATION("is_hpsiptalization", "VARCHAR", "isHpsiptalization", java.lang.String.class, false, true, false),
    ANTIBIOTICTREATMENT("antibiotic_treatment", "VARCHAR", "antibioticTreatment", java.lang.String.class, false, true, false),
    TREATMENT("treatment", "VARCHAR", "treatment", java.lang.String.class, false, true, false),
    ...
    PdDPatientComplicationColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
