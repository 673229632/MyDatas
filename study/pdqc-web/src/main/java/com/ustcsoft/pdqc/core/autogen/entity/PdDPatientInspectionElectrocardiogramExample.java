...
public class PdDPatientInspectionElectrocardiogramExample implements ModelColumnSupport, AutoGenExample {
    /**
     * 排序.
     */
    ...
    public PdDPatientInspectionElectrocardiogramExample() {
    ...
    public ModelColumn[] getColumnList() {
        return PdDPatientInspectionElectrocardiogramColumnEnum.values();
    }
