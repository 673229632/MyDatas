...
public class PdMTitleEmployeeExample implements AutoGenExample, ModelColumnSupport {
    /**
     * 排序.
     */
    ...
    public PdMTitleEmployeeExample() {
    ...
    public ModelColumn[] getColumnList() {
        return PdMTitleEmployeeColumnEnum.values();
    }
