...
public class PdDPatientInspectionRoutineStoolExample implements ModelColumnSupport, AutoGenExample {
    /**
     * 排序.
     */
    ...
    public PdDPatientInspectionRoutineStoolExample() {
    ...
    public ModelColumn[] getColumnList() {
        return PdDPatientInspectionRoutineStoolColumnEnum.values();
    }
