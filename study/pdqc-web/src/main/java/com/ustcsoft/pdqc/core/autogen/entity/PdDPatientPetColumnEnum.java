...
/**
 * Table [pd_d_patient_pet]`s Columns.
 */
public enum PdDPatientPetColumnEnum implements ModelColumn {
    ...
    PERTONEALTRANSPORTRATE("pertoneal_transport_rate", "VARCHAR", "pertonealTransportRate", java.lang.String.class, false, true, false),
    ...
    PdDPatientPetColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
