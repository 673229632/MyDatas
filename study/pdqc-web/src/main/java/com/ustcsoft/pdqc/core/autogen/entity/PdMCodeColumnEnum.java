...
/**
 * Table [pd_m_code]`s Columns.
 */
public enum PdMCodeColumnEnum implements ModelColumn {
    PARENTCODE("parent_code", "VARCHAR", "parentCode", java.lang.String.class, true, false, false),
    CODE("code", "VARCHAR", "code", java.lang.String.class, true, false, false),
    ORGID("org_id", "VARCHAR", "orgId", java.lang.String.class, false, false, false),
    VALUE("value", "VARCHAR", "value", java.lang.String.class, false, true, false),
    DESCRIPTION("description", "VARCHAR", "description", java.lang.String.class, false, true, false),
    ...
    PdMCodeColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
