...
public class PdMExamineSchedulejhsjExample implements AutoGenExample, ModelColumnSupport {
    /**
     * 排序.
     */
    ...
    public PdMExamineSchedulejhsjExample() {
    ...
    public ModelColumn[] getColumnList() {
        return PdMExamineSchedulejhsjColumnEnum.values();
    }
