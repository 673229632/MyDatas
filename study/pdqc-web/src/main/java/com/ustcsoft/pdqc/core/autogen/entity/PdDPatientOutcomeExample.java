...
public class PdDPatientOutcomeExample implements ModelColumnSupport, AutoGenExample {
    /**
     * 排序.
     */
    ...
    public PdDPatientOutcomeExample() {
    ...
    public ModelColumn[] getColumnList() {
        return PdDPatientOutcomeColumnEnum.values();
    }
