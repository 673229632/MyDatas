...
/**
 * Table [pd_d_patient_inspection_routine_stool]`s Columns.
 */
public enum PdDPatientInspectionRoutineStoolColumnEnum implements ModelColumn {
    ...
    PdDPatientInspectionRoutineStoolColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
