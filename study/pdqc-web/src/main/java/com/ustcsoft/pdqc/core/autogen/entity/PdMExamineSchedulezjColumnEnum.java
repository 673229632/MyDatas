...
/**
 * Table [pd_m_examine_schedulezj]`s Columns.
 */
public enum PdMExamineSchedulezjColumnEnum implements ModelColumn {
    SCHEDULEZJID("schedulezj_id", "VARCHAR", "schedulezjId", java.lang.String.class, true, false, false),
    SPECIALISTNO("specialist_no", "VARCHAR", "specialistNo", java.lang.String.class, false, false, false),
    ...
    PdMExamineSchedulezjColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
