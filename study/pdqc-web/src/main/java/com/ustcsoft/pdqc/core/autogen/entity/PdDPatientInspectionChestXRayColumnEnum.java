...
/**
 * Table [pd_d_patient_inspection_chest_x_ray]`s Columns.
 */
public enum PdDPatientInspectionChestXRayColumnEnum implements ModelColumn {
    ...
    PdDPatientInspectionChestXRayColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
