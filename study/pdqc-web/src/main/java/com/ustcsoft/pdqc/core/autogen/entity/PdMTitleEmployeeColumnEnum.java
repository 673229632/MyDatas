...
/**
 * Table [pd_m_title_employee]`s Columns.
 */
public enum PdMTitleEmployeeColumnEnum implements ModelColumn {
    ...
    PdMTitleEmployeeColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
