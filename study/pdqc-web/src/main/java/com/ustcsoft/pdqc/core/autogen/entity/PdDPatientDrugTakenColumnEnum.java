...
/**
 * Table [pd_d_patient_drug_taken]`s Columns.
 */
public enum PdDPatientDrugTakenColumnEnum implements ModelColumn {
    ...
    TYPE2("type2", "VARCHAR", "type2", java.lang.String.class, false, true, false),
    TYPE3("type3", "VARCHAR", "type3", java.lang.String.class, false, true, false),
    DRUGNAME("drug_name", "VARCHAR", "drugName", java.lang.String.class, false, true, false),
    FREQUENCY("frequency", "VARCHAR", "frequency", java.lang.String.class, false, true, false),
    METHOD("method", "VARCHAR", "method", java.lang.String.class, false, true, false),
    SINGLEDOSE("single_dose", "VARCHAR", "singleDose", java.lang.String.class, false, true, false),
    ...
    PdDPatientDrugTakenColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
