...
/**
 * Table [pd_d_patient_inspection_renal_b_ultrasound]`s Columns.
 */
public enum PdDPatientInspectionRenalBUltrasoundColumnEnum implements ModelColumn {
    ...
    RLENGTH("rlength", "VARCHAR", "rlength", java.lang.String.class, false, true, false),
    RWIDTH("rwidth", "VARCHAR", "rwidth", java.lang.String.class, false, true, false),
    LLENGTH("llength", "VARCHAR", "llength", java.lang.String.class, false, true, false),
    LWIDTH("lwidth", "VARCHAR", "lwidth", java.lang.String.class, false, true, false),
    ...
    PdDPatientInspectionRenalBUltrasoundColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
