...
/**
 * Table [pd_m_user_role]`s Columns.
 */
public enum PdMUserRoleColumnEnum implements ModelColumn {
    ...
    PdMUserRoleColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
