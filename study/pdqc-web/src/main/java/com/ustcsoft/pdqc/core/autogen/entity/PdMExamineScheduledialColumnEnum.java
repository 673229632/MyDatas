...
/**
 * Table [pd_m_examine_scheduledial]`s Columns.
 */
public enum PdMExamineScheduledialColumnEnum implements ModelColumn {
    SCHEDULEDIALID("scheduledial_id", "VARCHAR", "scheduledialId", java.lang.String.class, true, false, false),
    PDCENTERNO("pd_center_no", "VARCHAR", "pdCenterNo", java.lang.String.class, false, false, false),
    EXECUTETIMENO("execute_time_no", "VARCHAR", "executeTimeNo", java.lang.String.class, false, false, false),
    ...
    PdMExamineScheduledialColumnEnum(String name, String type, String javaName, Class<?> javaType, boolean primaryKey, boolean nullable, boolean blobColumn) {
        this.name = name;
        this.type = type;
